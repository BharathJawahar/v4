/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-0146fbee4edfc447f95e.js.LICENSE.txt */
  ...
  [98],
  {
    4991: function(e) {
      ...
      e.exports = JSON.parse(
        '{"layout":"constrained","backgroundColor":"#e8e8e8","images":{"fallback":{"src":"/v4/static/30a645f7db6038f83287d0c6042d3b2b/25f3c/me.jpg","srcSet":"/v4/static/30a645f7db6038f83287d0c6042d3b2b/2dd75/me.jpg 125w,\\n/v4/static/30a645f7db6038f83287d0c6042d3b2b/754ad/me.jpg 250w,\\n/v4/static/30a645f7db6038f83287d0c6042d3b2b/25f3c/me.jpg 500w","sizes":"(min-width: 500px) 500px, 100vw"},"sources":[{"srcSet":"/v4/static/30a645f7db6038f83287d0c6042d3b2b/aebc8/me.avif 125w,\\n/v4/static/30a645f7db6038f83287d0c6042d3b2b/6b255/me.avif 250w,\\n/v4/static/30a645f7db6038f83287d0c6042d3b2b/f9526/me.avif 500w","type":"image/avif","sizes":"(min-width: 500px) 500px, 100vw"},{"srcSet":"/v4/static/30a645f7db6038f83287d0c6042d3b2b/4155f/me.webp 125w,\\n/v4/static/30a645f7db6038f83287d0c6042d3b2b/02deb/me.webp 250w,\\n/v4/static/30a645f7db6038f83287d0c6042d3b2b/1ee78/me.webp 500w","type":"image/webp","sizes":"(min-width: 500px) 500px, 100vw"}]},"width":500,"height":500}',
      );
    },
    2122: function(e, t, n) {
      'use strict';
    ...
    5414: function(e, t, n) {
      ...
      const N = 'defaultTitle';
      const P = 'defer';
      const z = 'encodeSpecialCharacters';
      const M = 'onChangeClientState';
      const R = 'titleTemplate';
      const _ = Object.keys(I).reduce(function(e, t) {
        return (e[I[t]] = t), e;
      }, {});
      const D = [y.NOSCRIPT, y.SCRIPT, y.STYLE];
    ...
    165: function(e, t) {
      ...
      const b = n ? Symbol.for('react.fundamental') : 60117;
      const y = n ? Symbol.for('react.responder') : 60118;
    ...
    9: function(e, t, n) {
          ...
          (c.use = function e(t) {
            switch (t) {
              ...
              case null:
                ...
                break;
              default:
                if ('function' === typeof t) {N[P++] = t;} else if ('object' === typeof t) {for (let n = 0, r = t.length; n < r; ++n) {e(t[n]);}} else {M = 0 | !!t;}
            }
            return e;
          }),
          (c.set = l),
      ...
      const z = new RegExp(`^${  w  }\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)`);
      ...
      let H = E;
      const $ = { isServer: !E, useCSSOMInjection: !k };
      const q = (function() {
        function e(e, t, n) {
          void 0 === e && (e = v),
          void 0 === t && (t = {}),
          ...
          (e.prototype.generateAndInjectStyles = function(e, t, n) {
            ...
            if (
              ...
              if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId)) {i.push(this.staticRulesId);} else {
                ...
                const o = G(V(this.baseHash, a.length) >>> 0);
      ...
      function Te(e) {
        ...
        for (let i = 0, a = n; i < a.length; i++) {
          const o = a[i];
          if (Ce(o)) {for (const s in o) {Se(s) && Ae(e, o[s], s);}}
        }
        return e;
      }
      ...
      function Ie(e, t, n) {
        ...
        r &&
          ...
          (E = t.shouldForwardProp
            ...
            : e.shouldForwardProp);
        let k;
        const C = new Q(n, h, r ? e.componentStyle : void 0);
        const S = C.isStatic && 0 === s.length;
      ...
      function ze(e) {
        ...
        function c(e, t, n, r, i) {
          if (s.isStatic) {s.renderStyles(e, C, n, i);} else {
            const a = p({}, t, { theme: be(t, r, l.defaultProps) });
    ...
    7140: function(e, t, n) {
      ...
      const B = { duration: 1e3, delay: 0, endDelay: 0, easing: 'easeOutElastic(1, .5)', round: 0 };
      const Z = [
        'translateX',
        'translateY',
        'translateZ',
      ...
      function V(e, t) {
        const n = G(e);
        const r = $(Y.und(n[0]) ? 1 : n[0], 0.1, 100);
        const i = $(Y.und(n[1]) ? 100 : n[1], 0.1, 100);
        const a = $(Y.und(n[2]) ? 10 : n[2], 0.1, 100);
        const o = $(Y.und(n[3]) ? 0 : n[3], 0.1, 100);
      ...
      function le(e, t) {
        const n = oe(e);
        for (const r in t) {n[r] = Y.und(e[r]) ? t[r] : e[r];}
        return n;
      }
      function ce(e) {
        return Y.rgb(e)
      ...
      function Ae(e, t) {
        ...
        const r = `${xe(Y.pth(e) ? e.totalLength : e, t)  }`;
        return {
          original: r,
      ...
      function Le(e, t) {
        ...
        return i
          .map(function(e, n) {
            const r = Y.obj(e) && !Y.pth(e) ? e : { value: e };
            return (
      ...
      function je(e, t) {
                ...
                var t = ne(
                  ...
                  r = function(r) {
                    ...
                    n[i] = e.map(function(e) {
                      const t = {};
                      for (const n in e) {Y.key(n) ? n == i && (t.value = e[n]) : (t[n] = e[n]);}
                      return t;
                    });
                  },
                  i = 0;
        ...
        t)) {Y.key(i) && n.push({ name: i, tweens: Le(t[i], e) });}
        return n;
      }
      function Ie(e, t) {
        let n;
        return e.tweens.map(function(r) {
          ...
          let o = Y.arr(a) ? a[1] : a;
          const s = ue(o);
          const l = be(t.target, e.name, s, t);
          const c = n ? n.to.original : l;
          const u = Y.arr(a) ? a[0] : c;
          const d = ue(u) || ue(l);
          const f = s || d;
          return (
            Y.und(o) && (o = c),
      ...
      function Ze(e, t) {
        for (let n = t.length; n--; ) {ae(e, t[n].animatable.target) && t.splice(n, 1);}
      }
      function He(e, t) {
      ...
      (Be.stagger = function(e, t) {
        ...
        const r = t.easing ? ee(t.easing) : null;
        const i = t.grid;
        const a = t.axis;
        let o = t.from || 0;
        const s = 'first' === o;
        ...
        return function(e, t, v) {
          if ((s && (o = 0), l && (o = (v - 1) / 2), c && (o = v - 1), !h.length)) {
            for (let b = 0; b < v; b++) {
              if (i) {
                const y = l ? (i[0] - 1) / 2 : o % i[0];
                const x = l ? (i[1] - 1) / 2 : Math.floor(o / i[0]);
                const w = y - (b % i[0]);
                const E = x - Math.floor(b / i[0]);
      ...
      const Je = n(4165);
      const Xe = n(3082);
      const Qe = c.ZP.header.withConfig({ displayName: 'nav__StyledHeader', componentId: 'ghklvd-0' })(
        [
          '',
      ...
      const Ke = c.ZP.nav.withConfig({ displayName: 'nav__StyledNav', componentId: 'ghklvd-1' })(
        [
          '',
      ...
      const et = c.ZP.div.withConfig({ displayName: 'nav__StyledLinks', componentId: 'ghklvd-2' })(
        [
      ...
      const nt = n(18);
      const rt = c.ZP.div.withConfig({ displayName: 'menu__StyledMenu', componentId: 'sdn9y6-0' })([
        'display:none;@media (max-width:768px){display:block;}',
      ]);
      const it = c.ZP.button.withConfig({
      ...
      const at = c.ZP.aside.withConfig({ displayName: 'menu__StyledSidebar', componentId: 'sdn9y6-2' })(
        [
          'display:none;@media (max-width:768px){',
      ...
      const pt = c.ZP.footer.withConfig({
      ...
      var bt = function() {
        ...
        const a = [
          r.createElement('h1', null, 'Hello Hooman! I’m'),
          r.createElement('h2', { className: 'big-heading' }, 'Bharath Jawahar'),
          r.createElement(
            'h3',
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                'a',
                { href: 'https://chennai.vit.ac.in/', target: '_blank', rel: 'noreferrer' },
                'VIT, Chennai',
              ),
              ', ',
              ...
              r.createElement(
                'a',
                { href: 'https://www.nokia.com', target: '_blank', rel: 'noreferrer' },
                'Nokia',
              ),
              ' ',
            ),
            r.createElement(
              'p',
              null,
              'I have smashed many keyboards to learn various like Android/Web Development, ML, Big Data, and others. But still looking for my niche and inner peace that makes me stop smashing the keyboard. Currently, I’m smashing my keyboards to learn Linux and Terminal. BTW, I use Arch (No, I can\'t hack your devices or accounts. Or can I?)',
            ),
          ),
          r.createElement(
            'a',
            {
              ...
              href:
                  'https://drive.google.com/file/d/1q85DyRuHpFmiKvGanPGONLie6-JXtg-3/view?usp=sharing',
              target: '_blank',
              rel: 'noreferrer',
            },
            'Check out my Resume!',
      ...
      const yt = n(9285);
      const xt = n(355);
      const wt = c.ZP.section.withConfig({
      ...
      const kt = c.ZP.div.withConfig({ displayName: 'about__StyledPic', componentId: 'sc-1ownso9-2' })(
        [
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  'p',
                  null,
                  'Hello again, Hooman! My name is Bharath Jawahar (don\'t call me BJ) and I enjoy developing all kinds of stuff (Not really, only if it has to do with tech). I am an Introvert and love (need) to be on my couch all year. I coded my first Hello World at my high schooling, and since then I learned to code the same in more than 7 different languages (programming languages)',
                ),
                r.createElement(
                  'p',
                  null,
                  'Fast-forward to today, and I’ve worked on 3 Android Apps, many Web development projects, (built, trained, and) deployed an ML Model and got hands dirty on technologies like Unity, .NET, and Hadoop. My main focus these days is building accessible, inclusive products and digital experiences',
                ),
                r.createElement('p', null, 'Here are a few technologies I’ve worked with :'),
              ),
              r.createElement(
                'ul',
      ...
      const St = c.ZP.section.withConfig({
      ...
      const Tt = c.ZP.button.withConfig({
      ...
      var zt = function() {
        const e = (0, o.useStaticQuery)('2681795072').featured.edges.filter(function(e) {
          return e.node;
        });
      ...
      const Mt = c.ZP.section.withConfig({
      ...
      const Dt = c.ZP.section.withConfig({
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              'p',
              null,
              'I’m pretty sure that most of the time I will be on my couch, but if you found me at a party, which is never gonna happen, or in a cafe, don\'t hesitate to say hi. Let’s discuss why Your Name is my favourite anime, or whether it’s Javascript or JavaScript.',
            ),
            r.createElement(
              'a',
    ...
    355: function(e, t, n) {
      ...
      function M(e, t) {
        if ((void 0 === t && (t = this.pristine), !e.visible && e.revealed && e.config.reset)) {return I.call(this, e, { reset: !0 });}
        ...
        if (n) {
          ...
          if (!n.blocked.head && r === [].concat(a.head).pop() && r >= [].concat(i.body).shift()) {return D.call(this, n, r, -1, t), I.call(this, e, { reveal: !0, pristine: t });}
          if (!n.blocked.foot && r === [].concat(a.foot).shift() && r <= [].concat(i.body).pop()) {return D.call(this, n, r, 1, t), I.call(this, e, { reveal: !0, pristine: t });}
        }
      }
      function R(e) {
        const t = Math.abs(e);
      ...
      let Y; let G; let V; let U; let J; let X; let Q; let K;
      function ee(e) {
        let t;
        if (
          (void 0 === e && (e = {}),
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-0146fbee4edfc447f95e.js.map
