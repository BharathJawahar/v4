(self.webpackChunkv4 = self.webpackChunkv4 || []).push([
  [156],
  {
    3174: function(e, t, n) {
      ...
      const p = l.ZP.ul.withConfig({ displayName: 'pensieve__StyledGrid', componentId: 'jb5p05-1' })(
        [
          '',
      ...
      const d = l.ZP.li.withConfig({ displayName: 'pensieve__StyledPost', componentId: 'jb5p05-2' })(
        [
    ...
    2757: function(e) {
      ...
      const v = '(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?';
      const h = '[\\ufe0e\\ufe0f]?';
      const b = `${h + v  }(?:\\u200d(?:${  ['[^\\ud800-\\udfff]', s, c].join('|')  })${  h  }${v  })*`;
      const y = `(?:${  [u, s, c].join('|')  })${  b}`;
      const w = RegExp(
        [
          `${p  }?${  l  }+${  m  }(?=${  [i, p, '$'].join('|')  })`,
          `${x  }+${  g  }(?=${  [i, p + d, '$'].join('|')  })`,
